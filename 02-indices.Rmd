...
properly defined on unconnected networks. vf-irmeicrn-98 introduce *integration* as 
an index which evaluates how well a vertex is integrated in a network. It is defined as
$$
